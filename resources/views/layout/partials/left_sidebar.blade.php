    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #29b6f6; background: ">
        ...
        <span class="brand-text font-weight-bold text-dark">We Love One Piece</span>
        </a>
        ...
        <nav class="mt-2">
            ...
            <!-- Add icons to the links using the .nav-icon class
                ...
                <a href="/forum/create" type="submit" class="btn btn-light btn-block btn-lg text-dark mt-4" style="border-radius:50px" >พูดคุย</a>
